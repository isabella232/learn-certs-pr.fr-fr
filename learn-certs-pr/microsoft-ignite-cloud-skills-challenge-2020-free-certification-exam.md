...
<br/>
<br/>
![Valider la commande](images/ignite-cloud-skills-step9.png)
<br/>
<br/>
...
Si vous rencontrez des problèmes lors de la programmation de votre examen, obtenez de l’aide grâce à nos [Soutien à la certification Microsoft](https://trainingsupport.microsoft.com/fr-fr/mcp/forum/mcp_exams-mcp_offer-mcp_eventoffer?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=all&isFilterExpanded=false&page=1). Un modérateur du forum répondra dans les 24 heures (jours ouvrés).

## <a name="eligible-exams"></a> Examens éligibles

Les examens admissibles incluent tous les examens de certification Microsoft Fundamentals, basés sur les rôles et spécialisés. Les examens éligibles sont présentés ci-dessous. 
...
**R:** Cette offre inclut tous les examens de certification Microsoft Fundamentals, basés sur les rôles et de spécialisation. Pour obtenir la liste des examens de certification admissibles, consultez la section « [Examens admissibles](/apprendre/certifications/microsoft-build-cloud-skills-challenge-2020-free-certification-exam-offer#eligible-exams) » sur notre page de détails sur l’offre.

**Q: Si je me suis inscrit à Microsoft Ignite, mais que je ne me suis pas inscrit au Cloud Skills Challenge, puis-je quand même bénéficier de cette offre?**

**R:** Non, cette offre ne s’applique qu’aux personnes ayant assisté à Microsoft Ignite, et terminé l’une des compilations du Cloud Skills Challenge. 
