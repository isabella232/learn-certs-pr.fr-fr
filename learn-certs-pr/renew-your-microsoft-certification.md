...
Examinez la feuille de route suivante (sous réserve de modification) pendant que nous lançons initialement des évaluations de renouvellement pour des certifications existant sur le marché.

| Évaluations de renouvellement disponibles en début février 2021 |
| --- |
...
| Évaluations de renouvellement disponibles entre la mi-février et mars 2021 |
| --- |
...
Le 15 décembre 2020, nous avons [annoncé que la politique d’échéance des certifications a été modifiée](https://aka.ms/CertRenewalBlog). À compter de juin 2021, toute certification obtenue, [basée sur le rôle](/learn/certifications/browse/?type=role-based) ou [de spécialisation](/learn/certifications/browse/?type=specialty), sera valide pour un an depuis la date de son obtention. Toutes les certifications basées sur les rôles et de spécialisation obtenues avant juin 2021 resteront valides pendant une période de deux ans à compter de la date de leur obtention.
...
2. **Est-ce obligatoire de connecter mon profil de certification à mon profil Docs sur Microsoft Learn ?**
    ...
    Pour une expérience optimale, nous vous recommandons d’utiliser les mêmes identifiants de compte pour votre profil de certification et votre profil Docs sur Microsoft Learn. Veuillez noter qu’il est seulement possible de connecter un seul profil de certification à un profil Docs, et qu’il ne peut pas être modifié par la suite. Ainsi, si vous avez plusieurs profils de certification, veuillez [contacter notre équipe d’assistance à la certification](https://aka.ms/mcpforum) pour fusionner vos profils de certification Microsoft avant de les connecter à votre profil Docs.
...
4. **Ma certification a expiré. Que se passe-t-il maintenant ?**

    Si votre certification expire, vous devez l’obtenir à nouveau en passant le ou les examens requis.

5. **Puis-je renouveler ma certification en passant un examen bêta ou en repassant un examen avant l’échéance de ma certification ?**

    Non, pour renouveler votre certification, vous devez passer l’évaluation de renouvellement avant qu’elle n’expire.

6. **Toutes les certifications Microsoft peuvent-elles être renouvelées ?**
...
7. **Est-il nécessaire de renouveler ma certification Microsoft Fundamentals ?**
...
8. **Les évaluations de renouvellement sont-elles alignées sur la cadence normale de mise à jour des examens ?**

    Oui, les mises à jour des évaluations sont alignées sur les mises à jour des examens de certification.

9. **Dans quelles langues les évaluations sont-elles disponibles ?**
...
10. **Combien de fois est-il possible de repasser l’évaluation ?**
...
11. **Si je renouvelle ma certification basée sur les rôles de niveau expert et qu’elle comprend une certification prérequise de niveau Associate, ma certification de niveau Associate sera-t-elle automatiquement renouvelée ?**

    Non, chaque certification doit être renouvelée séparément en passant l’évaluation connexe.

12. **Ma certification de niveau expert exige un prérequis de certification de niveau Associé. Si la certification de niveau Associé expire, ma certification de niveau expert expirera-t-elle aussi automatiquement ?**
