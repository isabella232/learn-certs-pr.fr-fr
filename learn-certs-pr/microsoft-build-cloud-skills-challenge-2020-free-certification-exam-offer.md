...
![Cliquer sur le bouton « Vérifier le compte » sur la page « Remises sur les examens »](images/step5.png)

**Étape 6:** Lors de la vérification de votre compte, vous devez vous identifier à l’aide du compte utilisé pour l’inscription à l’événement (REMARQUE: Si vous avez utilisé un compte Microsoft pour l’inscription à un événement, vous devez utiliser le même compte Microsoft pour vous connecter à votre profil de certification afin de programmer votre examen. S’il résulte que vous avez deux profils de certification, contactez les [ d'aide à la Microsoft Certification](https://trainingsupport.microsoft.com/en-us/mcp/forum) pour fusionner vos profils après avoir passé votre examen de).
<br/><br/>

![S’identifier avec le compte de réseau social utilisé pour vérifier le compte](images/step6.png)

**Étape 7:** Suivez les étapes sur les écrans suivants et fournissez les détails nécessaires pour planifier votre examen. Lors du paiement, vérifiez que le montant total dû est de 0,00 $ et confirmez votre commande.
<br/><br/>

![Fournir les informations requises pour programmer votre examen](images/step7.png)
