...
Merci d’assister à un événement Microsoft Ignite 2019 ou Microsoft Ignite The Tour 2019-2020. Tous les participants recevront un examen de certification gratuit, sous réserve de certaines exceptions, *pour vous aider à continuer à améliorer vos compétences et prouver votre expertise technique à vos employeurs et vos pairs.
...
Comme c’est une offre numérique, nous exigeons que vous vérifiez votre participation à l’événement à l’aide du même compte social que vous avez utilisé pour votre inscription à l’événement (voir étape 7 ci-dessous) lors de la planification de votre examen en ligne. Si vous vous êtes inscrit avec un groupe, vérifiez que vous avez complété votre profil d’inscription à l’événement. Pour les participants à MS Ignite 2019, allez au [https://register.ignite.microsoft.com/](https://register.ignite.microsoft.com/) ; pour les participants au The Tour, veuillez vous diriger au [https://register.msignite-the-tour.microsoft.com/cityname](https://register.msignite-the-tour.microsoft.com/cityname), par exemple [https://register.msignite-the-tour.microsoft.com/london](https://register.msignite-the-tour.microsoft.com/london) pour compléter votre profil d'événement.

Pour les prises d'écran des étapes une à une, [voir ici](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE4i3R4).

***Pour vous inscrire à un examen gratuit:***

1. Sélectionnez l'un des examens de qualification mentionnés ci-dessous.
2. Une fois que vous avez accédé à la page d'informations de l'examen souhaité, cliquez sur le bouton « Planifier l'examen » pour lancer le processus d'inscription en ligne.
3. Connectez-vous avec le compte Microsoft associé à votre profil de certification Microsoft. Si vous ne possédez pas de profil de certification Microsoft, vous devrez en créer un.
4. Une fois que vous êtes connecté à votre profil de certification Microsoft, confirmez que les détails de votre profil de certification soient corrects.
5. Cliquez sur le « bouton Sauvegarder et continuer » en bas de la page du profil de certification pour continuer à la page des « réductions sur les examens ».
6. Sur la page des « réductions sur les examens », sélectionnez l’événement auquel vous avez assisté et cliquez sur le bouton « vérifier le compte ».
7. Pour vérifier votre compte, vous devez effectuer une authentification à l’aide du même compte social que vous avez utilisé pour vous inscrire à l’événement (REMARQUE : Si vous avez utilisé votre compte Microsoft pour vous inscrire à l'événement, vous devez utiliser le même compte Microsoft pour vous connecter à votre profil de certification afin de planifier votre examen.
Si vous obtenez par conséquent deux profils de certification, contactez [les forums d'assistance de certification Microsoft](https://trainingsupport.microsoft.com/en-us/mcp/forum?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=All&isFilterExpanded=false&page=1) pour fusionner vos profils après avoir terminé votre examen de certification.)
8. Suivez les étapes sur les écrans suivants et fournissez les détails nécessaires pour planifier votre examen.
9. Lors du paiement, vérifiez que le montant total soit de 0,00$ et validez la commande. Remarque: La page 'Ma commande’ devrait afficher la remise suivante dans le bas de la page:  ***Remise à 100 % Microsoft Ignite 2019-2020***. Les pages précédentes du flux de planification des examens indiqueront le prix complet.
...
- Cette offre d'examen n'est pas valable pour, et ne peut pas être échangé par: 1) des représentants du gouvernement ou 2) des résidents de Hong Kong, de Taïwan, de Suisse, d'Israël, d'Allemagne ou de Suède. *Cette offre n’est pas disponible pour les représentants du gouvernement ou les résidents des pays mentionnés, car elle dépasse les limites autorisées en vertu de la politique de Microsoft et de la loi locale.
